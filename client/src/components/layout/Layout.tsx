...
const Layout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#060606] via-[#121212] to-[#242424] font-sans">
      ...
      {/* Modern Footer */}
      <footer className="border-t border-[#434546] py-8 bg-[#121212]/80 backdrop-blur-lg mt-auto">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8 mb-6">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mb-3">Built with ❤️ by NIE Students</p>
              <div className="flex space-x-3">
                <a href="#" className="text-gray-400 hover:text-[#b4a9e6] transition-colors p-2 bg-[#242424] rounded-lg hover:bg-[#b4a9e6]/20">
          ...
          <div className="border-t border-[#434546] pt-6 text-center text-gray-400 text-sm">
