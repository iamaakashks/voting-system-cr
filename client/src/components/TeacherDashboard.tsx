    ...
    <div className="relative max-w-7xl mx-auto">
      ...
      <motion.header initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">Manage elections, monitor live results and audits.</p>
        </div>

        <motion.button
          whileHover={{ scale: 1.03 }}
          className="px-6 py-3 rounded-xl bg-white text-black font-bold text-sm shadow-xl hover:bg-gray-200 transition"
          onClick={onCreateNew}
        >
          + Create New Election
        </motion.button>
